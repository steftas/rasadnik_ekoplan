...
class Orders extends CI_Controller{
	...
	function sendMailOrderMKD() {
		...
		if ($_POST) {
			...
			$name = 'RASADNIK Eko-Plan';
			$mailfrom = 'milosevicmarkoekoplan@gmail.com';
			$ime = $customer['name'];
			$prezime = $customer['lastname'];
			$adresa = $customer['address'];
			$zip = $customer['zip'];
			...
			foreach ($items as $item) {
				...
				$message.= "<tr>
								<td>$itemName</td>
								<td style='text-align: right;'>$itemPrice,00 MKD</td>
								<td style='text-align: right;'>$itemQuantity</td>
							</tr>";
			};									
			...
			$message.= "			</tbody>
										<tfoot>
											<tr>
												<td style='border-top: 1px solid #333;'></td>
												<td style='text-align: right; border-top: 1px solid #333;'>Isporuka</td>
												<td style='text-align: right; border-top: 1px solid #333;'>120,00 MKD</td>
											</tr>
											<tr>
												<td></td>
												<td style='text-align: right;'>Ukupno</td>
												<td style='text-align: right;'>$racun,00 MKD</td>
											</tr>
										</tfoot>
									</table>
									<p><b>Metod isporuke:</b> Dostava brzom poštom.</p>
